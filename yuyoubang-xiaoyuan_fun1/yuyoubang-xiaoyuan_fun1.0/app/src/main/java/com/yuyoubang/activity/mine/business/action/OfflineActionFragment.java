...
public class OfflineActionFragment extends BaseNetFragment<MyTripBean> {



    @Bind(R.id.offline_rv)
    RecyclerView offlineRv;
    @Bind(R.id.offline_sp)
    SwipeRefreshLayout offlineSp;
    ...
    public static OfflineActionFragment newInstance() {
        OfflineActionFragment fragment = new OfflineActionFragment();
...
//        testCall.enqueue(this);
    ...
    private void initView() {
        ...
        offlineSp.setColorSchemeColors(getActivity().getResources().getColor(R.color.color_ff9600));
        offlineSp.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
    ...
    protected int getContentResId() {
        return R.layout.frg_offline_action;
    }
