...
public class MoreLikeUserActivity extends BaseNetActivity<MoreLikeList> {
    ...
    protected void initViews() {
        ...
        //初始化adapter
        mAdapter = new FindMoreLikeUserAdapter(this, null, true,flag);
        //设置加载更多触发的事件监听
    ...
    private void getData(final String cursor) {
        ...
        Call<MoreLikeList> find = findApi.my_fans_list(body);
        find.enqueue(this);
