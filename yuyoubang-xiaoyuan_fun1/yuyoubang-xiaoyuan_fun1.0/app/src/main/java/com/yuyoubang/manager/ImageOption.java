...
public class ImageOption {
    ...
    public static final DisplayImageOptions default_trip_options = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.mipmap.icon_default_trip) //设置图片在下载期间显示的图片
            .showImageForEmptyUri(R.mipmap.icon_default_trip)//设置图片Uri为空或是错误的时候显示的图片
            .showImageOnFail(R.mipmap.icon_default_trip)  //设置图片加载/解码过程中错误时候显示的图片
            .cacheOnDisk(true)//设置下载的图片是否缓存在SD卡中
            .considerExifParams(true)  //是否考虑JPEG图像EXIF参数（旋转，翻转）
            .resetViewBeforeLoading(true)//设置图片在下载前是否重置，复位
            .build();//构建完成
    ...
    public static final DisplayImageOptions default_banner_options = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.mipmap.icon_default_banner) //设置图片在下载期间显示的图片
            .showImageForEmptyUri(R.mipmap.icon_default_banner)//设置图片Uri为空或是错误的时候显示的图片
            .showImageOnFail(R.mipmap.icon_default_banner)  //设置图片加载/解码过程中错误时候显示的图片
            .cacheOnDisk(true)//设置下载的图片是否缓存在SD卡中
            .considerExifParams(true)  //是否考虑JPEG图像EXIF参数（旋转，翻转）
            .resetViewBeforeLoading(true)//设置图片在下载前是否重置，复位
            .build();//构建完成
    ...
    public static final DisplayImageOptions default_like = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.mipmap.like_icon) //设置图片在下载期间显示的图片
            .showImageForEmptyUri(R.mipmap.like_icon)//设置图片Uri为空或是错误的时候显示的图片
            .showImageOnFail(R.mipmap.like_icon)  //设置图片加载/解码过程中错误时候显示的图片
            .cacheOnDisk(true)//设置下载的图片是否缓存在SD卡中
            .considerExifParams(true)  //是否考虑JPEG图像EXIF参数（旋转，翻转）
            .resetViewBeforeLoading(true)//设置图片在下载前是否重置，复位
            .build();//构建完成
    ...
    public static final DisplayImageOptions default_avatar = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.mipmap.ease_default_avatar) //设置图片在下载期间显示的图片
            .showImageForEmptyUri(R.mipmap.ease_default_avatar)//设置图片Uri为空或是错误的时候显示的图片
            .showImageOnFail(R.mipmap.ease_default_avatar)  //设置图片加载/解码过程中错误时候显示的图片
            .cacheOnDisk(true)//设置下载的图片是否缓存在SD卡中
            .considerExifParams(true)  //是否考虑JPEG图像EXIF参数（旋转，翻转）
            .resetViewBeforeLoading(true)//设置图片在下载前是否重置，复位
            .build();//构建完成
    public static final DisplayImageOptions default_group_avatar = new DisplayImageOptions.Builder()
            .showImageOnLoading(R.mipmap.default_teams_avatar) //设置图片在下载期间显示的图片
            .showImageForEmptyUri(R.mipmap.default_teams_avatar)//设置图片Uri为空或是错误的时候显示的图片
            .showImageOnFail(R.mipmap.default_teams_avatar)  //设置图片加载/解码过程中错误时候显示的图片
            .cacheOnDisk(true)//设置下载的图片是否缓存在SD卡中
            .considerExifParams(true)  //是否考虑JPEG图像EXIF参数（旋转，翻转）
            .resetViewBeforeLoading(true)//设置图片在下载前是否重置，复位
            .build();//构建完成
