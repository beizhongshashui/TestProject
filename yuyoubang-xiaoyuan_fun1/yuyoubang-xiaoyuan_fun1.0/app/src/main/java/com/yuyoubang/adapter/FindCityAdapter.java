...
public class FindCityAdapter extends MultiBaseAdapter<FindFollowBean.ResultBean.ListBean> {
    private Context context;
    private List<String> tempList = new ArrayList<>();
    private String locationCity = "";

    public FindCityAdapter(Context context, List<FindFollowBean.ResultBean.ListBean> listBean, boolean isOpenLoadMore) {
    ...
    protected void convert(ViewHolder holder, final FindFollowBean.ResultBean.ListBean data, int viewType) {
        ...
        QLog.d("FindInfoAdapter",""+data.getData().getUser_location());
        QLog.d("FindInfoAdapter",""+data.getUser().getUser_data().getProvince());
        QLog.d("FindInfoAdapter","user_location"+data.getUser().getUser_data().getUser_location());
        if (data.getUser() != null) {

            //
            if (data.getUser().getUser_data().getUser_location().contains("市")) {//直辖市
