 ...
 */
public class OtherInfoActivity extends BaseNetActivity<FindCommentList> {
    ...
    private OtherHome.ResultBean.ListBean listBean;
    ...
    public static void start(Context context, OtherHome.ResultBean.ListBean listBean) {
    ...
    protected void initViews() {
        ...
        listBean = (OtherHome.ResultBean.ListBean) getIntent().getExtras().getSerializable("find");
        ...
        right.setOnClickListener(new OnClickListener() {
            @Override
            protected void clickOperate() {
                LaunchOperate.openFeedbackActivity(OtherInfoActivity.this,1);
            }
        });
    }
    ...
    private void sendCommentContent(String trim) {
        ...
        sendCommentCall.enqueue(new Callback<SendComment>() {
            ...
            public void onResponse(Call<SendComment> call, Response<SendComment> response) {
                ...
                loadData();
                KeyBoardUtil.closeSoftEdit(OtherInfoActivity.this, editTextMessage);
                    ...
                    if (findFollowInfoBean.getResult() != null) {
                        ...
                        iv_star.setOnClickListener(new OnClickListener() {
                            ...
                            protected void clickOperate() {//点赞
                                if (is_liked == 1) {
                                    iv_star.setImageResource(R.mipmap.act_info_like);
                                    closeStar(listBean.getId() + "", PreferenceUtils.getsessionId(OtherInfoActivity.this) + "");
                                    is_liked = 0;
                                } else {
                                    iv_star.setImageResource(R.mipmap.act_info_like_focus);
                                    openStar(listBean.getId() + "", PreferenceUtils.getsessionId(OtherInfoActivity.this) + "");
                                    is_liked = 1;
                                }
                            }
                        });
    ...
    public void showPopFormBottom() {
        ...
        SharePopwin sharePopwin = new SharePopwin(this, listBean.getId() + "", image, String.valueOf(listBean.getData().getContent()), 2);
