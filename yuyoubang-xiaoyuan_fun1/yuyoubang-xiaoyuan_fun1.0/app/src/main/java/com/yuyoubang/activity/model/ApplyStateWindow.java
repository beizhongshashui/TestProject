...
public class ApplyStateWindow extends PopupWindow implements View.OnClickListener {
    ...
    public ApplyStateWindow(Context context, IsCloseClickListener isLogoutClickListener) {
        super(context);
        this.context = context;
        this.isLogoutClickListener = isLogoutClickListener;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.popwindow_applystate_layout, null);
