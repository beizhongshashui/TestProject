...
public class FindHotAdapter extends MultiBaseAdapter<FindFollowBean.ResultBean.ListBean> {
    private Context context;
    private List<String> tempList = new ArrayList<>();
    private String locationCity = "";

    public FindHotAdapter(Context context, List<FindFollowBean.ResultBean.ListBean> listBean, boolean isOpenLoadMore) {
...
//                location.setText(data.getUser().getUser_data().getUser_location());
                ...
                location.setText(data.getData().getLocation());
            }*/
