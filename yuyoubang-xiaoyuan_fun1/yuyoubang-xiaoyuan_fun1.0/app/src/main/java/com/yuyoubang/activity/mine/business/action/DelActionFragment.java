...
public class DelActionFragment extends BaseNetFragment<MyTripBean> {
    ...
    public static DelActionFragment newInstance() {
        DelActionFragment fragment = new DelActionFragment();
