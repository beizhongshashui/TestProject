...
import com.yuyoubang.fragment.message.chat.EaseAtMessageHelper;
import com.yuyoubang.fragment.message.chat.EaseCommonUtils;
import com.yuyoubang.fragment.message.chat.EaseNotifier;
import com.yuyoubang.fragment.message.chat.EaseUI;
import com.yuyoubang.fragment.message.emojicon.EaseEmojicon;
import com.yuyoubang.fragment.message.emojicon.EaseEmojiconGroupEntity;
import com.yuyoubang.fragment.message.receiver.CallReceiver;
    ...
    protected void setEaseUIProviders() {
        ...
        easeUI.setSettingsProvider(new EaseUI.EaseSettingsProvider() {
            ...
            public boolean isMsgVibrateAllowed(EMMessage message) {
                boolean settingMsgInfo = PreferenceUtils.getPrefBoolean(appContext, SettingActivity.SETTING_msg, true);
                if (settingMsgInfo){
                    return true;
                }else {
                    return false;
...
//                return demoModel.getSettingMsgSound();
            ...
            public boolean isMsgNotifyAllowed(EMMessage message) {
                ...
                boolean settingMsgNotification = demoModel.getSettingMsgNotification();
                boolean settingMsgSound = demoModel.getSettingMsgSound();
                boolean settingMsgVibrate = demoModel.getSettingMsgVibrate();
...
//            msg.addBody(new EMTextMessageBody(inviter + " " + st3));
            msg.addBody(new EMTextMessageBody(inviteMessage));
