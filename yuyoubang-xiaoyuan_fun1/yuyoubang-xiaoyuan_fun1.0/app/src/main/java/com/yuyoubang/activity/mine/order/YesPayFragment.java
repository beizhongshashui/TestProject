...
public class YesPayFragment extends BaseNetFragment<Order> {


    @Bind(R.id.yes_pay_order_rv)
    RecyclerView yesPayOrderRv;
    @Bind(R.id.yes_pay_order_sp)
    SwipeRefreshLayout yesPayOrderSp;
    ...
    public static YesPayFragment newInstance() {
        YesPayFragment fragment = new YesPayFragment();
...
//        testCall.enqueue(this);
    ...
    private void initView() {
        ...
        yesPayOrderSp.setColorSchemeColors(getActivity().getResources().getColor(R.color.color_ff9600));
        yesPayOrderSp.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
        ...
        yesPayOrderRv.setLayoutManager(layoutManager);
        yesPayOrderRv.setAdapter(mAdapter);
        getData("");
    ...
    private void getData(final String cursor) {
        ...
        Call<Order> order = mineApi.my_trip_participate_list_payed(body);
        order.enqueue(this);
    }
    ...
    protected void processData(Order order) {
        ...
        if (TextUtils.isEmpty(cursor)) {
            ...
            yesPayOrderSp.setRefreshing(false);
    ...
    protected int getContentResId() {
        return R.layout.frg_order_yes_pay;
    }
