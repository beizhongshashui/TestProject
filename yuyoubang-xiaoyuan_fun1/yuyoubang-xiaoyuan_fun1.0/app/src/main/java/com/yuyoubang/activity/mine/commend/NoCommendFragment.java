...
public class NoCommendFragment extends BaseNetFragment<NoCommend> {

    private MineNoCommentAdapter mAdapter;
    private String cursor;

    private List<NoCommend.ResultBean.ListBean> mData = new ArrayList<>();
    private SwipeRefreshLayout findFollowSp;
    private FrameLayout null_comment;
    private TextView empty_text;

    public static NoCommendFragment newInstance() {
        NoCommendFragment fragment = new NoCommendFragment();
    ...
    protected void initViews() {
        ...
        //初始化adapter
        mAdapter = new MineNoCommentAdapter(getActivity(), null, true);
        //设置加载更多触发的事件监听
    ...
    private void getData(final String cursor) {
        ...
        Call<NoCommend> noCommendCall = mineApi.not_comment_list(body);
    ...
    @Subscribe
    public void comment(CommentBus commentBus) {
        getData("");
