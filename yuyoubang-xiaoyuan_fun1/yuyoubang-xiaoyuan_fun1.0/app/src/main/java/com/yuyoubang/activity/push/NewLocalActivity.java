...
import com.yuyoubang.adapter.PoiSearchAdapter;
...
public class NewLocalActivity extends BaseActivity implements LocationSource,
    ...
    protected int getContentResId() {
        return R.layout.activity_newlocal;
    }
    ...
    private void setUpMap() {
        ...
        myLocationStyle.myLocationIcon(BitmapDescriptorFactory
                .fromResource(R.mipmap.ease_icon_marka));// 设置小蓝点的图标
    ...
    public void onPoiSearched(PoiResult result, int rCode) {
        if (rCode == 0) {
            ...
            LogUtils.e("error_network");
        } else if (rCode == 32) {
            LogUtils.e("error_key");
        } else {
            LogUtils.e("error_other：" + rCode);
        }
    }
    ...
    private class mOnItemClickListener implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
            ...
            intent.putExtra("location", poiItems.get(position).getTitle());
