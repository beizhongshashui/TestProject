 ...
 */
public class MineStatusActivity extends BaseNetActivity<FindCommentList> {
    ...
    private MineDoTan.ResultBean.ListBean listBean;
    ...
    public static void start(Context context, MineDoTan.ResultBean.ListBean listBean) {
        Intent intent = new Intent(context, MineStatusActivity.class);
    ...
    protected void initViews() {
        ...
        listBean = (MineDoTan.ResultBean.ListBean) getIntent().getExtras().getSerializable("find");
        ...
        right.setOnClickListener(new OnClickListener() {
            @Override
            protected void clickOperate() {
                LaunchOperate.openFeedbackActivity(MineStatusActivity.this,1);
            }
        });
    }
    ...
    private void sendCommentContent(String trim) {
        ...
        sendCommentCall.enqueue(new Callback<SendComment>() {
            ...
            public void onResponse(Call<SendComment> call, Response<SendComment> response) {
                ...
                loadData();
                KeyBoardUtil.closeSoftEdit(MineStatusActivity.this, editTextMessage);
                    ...
                    if (findFollowInfoBean.getResult() != null) {
                        ...
                        iv_star.setOnClickListener(new OnClickListener() {
                            ...
                            protected void clickOperate() {//点赞
                                if (is_liked == 1) {
                                    iv_star.setImageResource(R.mipmap.act_info_like);
                                    closeStar(listBean.getId() + "", PreferenceUtils.getsessionId(MineStatusActivity.this) + "");
                                    is_liked = 0;
                                } else {
                                    iv_star.setImageResource(R.mipmap.act_info_like_focus);
                                    openStar(listBean.getId() + "", PreferenceUtils.getsessionId(MineStatusActivity.this) + "");
                                    is_liked = 1;
                                }
                            }
                        });
