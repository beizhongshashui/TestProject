...
//        //extend menu items
//        inputMenu.registerExtendMenuItem(R.string.attach_video, R.mipmap.ic_launcher, ITEM_VIDEO, extendMenuItemClickListener);
//        inputMenu.registerExtendMenuItem(R.string.attach_file, R.mipmap.ic_launcher, ITEM_FILE, extendMenuItemClickListener);
//        if (chatType == Constant.CHATTYPE_SINGLE) {
