package com.yuyoubang.fragment.message.chatrow;
...
import com.yuyoubang.fragment.message.photoview.EaseMessageAdapter;
...
//            EaseUserUtils.setUserAvatar(context, EMClient.getInstance().getCurrentUser(), userAvatarView);
            try {
                ImageLoader.getInstance().displayImage(message.getStringAttribute("fromeUserPic"),userAvatarView, ImageOption.defaultOptions);
...
//            EaseUserUtils.setUserNick(message.getFrom(), usernickView);
            try {
                ImageLoader.getInstance().displayImage(message.getStringAttribute("fromeUserPic"),userAvatarView, ImageOption.defaultOptions);
                usernickView.setText(message.getStringAttribute("fromeUserName").toString());
            } catch (HyphenateException e) {
                e.printStackTrace();
            }
        }
