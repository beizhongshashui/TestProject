...
public class MainActivity extends BaseActivity implements MyFragmentTabHost.OnTabClickListener, TabHost.OnTabChangeListener {
    ...
    void initTab() {
        ...
        mTabHost.addTab(learnSpec, HomeFragment.class, b);
        mTabHost.addTab(downloadSpec, HomeFragment.class, b, true);// true or false 表示是否加载网络
        mTabHost.addTab(writeSpec, HomeFragment.class, b);
        mTabHost.addTab(mesSpec, HomeFragment.class, b);
        mTabHost.addTab(mineSpec, HomeFragment.class, b);
