...
import com.yuyoubang.fragment.message.photoview.EaseBaseActivity;
import com.yuyoubang.fragment.message.photoview.EasePhotoView;
import com.yuyoubang.fragment.message.photoview.PhotoViewAttacher;
...
public class EaseShowBigImageActivity extends EaseBaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		left.setOnClickListener(new com.yuyoubang.listener.OnClickListener() {
			@Override
