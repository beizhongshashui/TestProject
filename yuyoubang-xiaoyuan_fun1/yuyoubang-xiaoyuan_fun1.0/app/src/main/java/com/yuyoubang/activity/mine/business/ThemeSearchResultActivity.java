...
public class ThemeSearchResultActivity extends BaseNetActivity<BusinessSearch> {
    ...
    private void getData(final String cursor) {
        ...
        Call<BusinessSearch> businessSearchCall = businessApi.search_order(body);
