...
public class ComplaintPopupWindow extends PopupWindow implements View.OnClickListener {
    private ImageView cancel;
    private TextView sure;
    private Context context;
    private ComplaintClickListener isLogoutClickListener;
    ...
    public ComplaintPopupWindow(Context context, ComplaintClickListener isLogoutClickListener) {
        super(context);
        this.context = context;
        this.isLogoutClickListener = isLogoutClickListener;
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.popwindow_conplaint_layout, null);
        ...
        et_price = (EditText) mMenuView.findViewById(R.id.et_price);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_sure:
                ...
                isLogoutClickListener.sure(type, num, because, price);
                dismiss();
                break;
            case R.id.iv_close:
