...
public class UnonlineActionFragment extends BaseNetFragment<MyTripBean> {



    @Bind(R.id.unonline_rv)
    RecyclerView unonlineRv;
    @Bind(R.id.unonline_sp)
    SwipeRefreshLayout unonlineSp;
    ...
    public static UnonlineActionFragment newInstance() {
        UnonlineActionFragment fragment = new UnonlineActionFragment();
...
//        testCall.enqueue(this);
    ...
    private void initView() {
        ...
        unonlineSp.setColorSchemeColors(getActivity().getResources().getColor(R.color.color_ff9600));
        unonlineSp.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
        ...
        unonlineRv.setLayoutManager(layoutManager);
        unonlineRv.setAdapter(mAdapter);
        getData("");
    ...
    protected void processData(MyTripBean myTripBean) {
        if (TextUtils.isEmpty(cursor)) {
            ...
            unonlineSp.setRefreshing(false);
    ...
    protected int getContentResId() {
        return R.layout.frg_unonline_action;
    }
