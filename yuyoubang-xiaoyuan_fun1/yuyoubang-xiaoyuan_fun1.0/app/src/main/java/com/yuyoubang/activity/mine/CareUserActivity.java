...
import com.yuyoubang.adapter.FindMoreCareUserAdapter;
...
public class CareUserActivity extends BaseNetActivity<MoreLikeList> {
    private FindMoreCareUserAdapter mAdapter;
    ...
    protected void initViews() {
        ...
        //初始化adapter
        mAdapter = new FindMoreCareUserAdapter(this, null, true,flag);
        //设置加载更多触发的事件监听
    ...
    protected void processData(MoreLikeList moreLikeList) {
        ...
        if (TextUtils.isEmpty(cursor)) {
            ...
            if (moreLikeList.getResult().getList() == null || moreLikeList.getResult().getList().size() == 0 || moreLikeList.getResult().getList().size() < 10) {
                mAdapter.setLoadEndView(R.layout.load_end_layout);
                return;
            }
        } else {
