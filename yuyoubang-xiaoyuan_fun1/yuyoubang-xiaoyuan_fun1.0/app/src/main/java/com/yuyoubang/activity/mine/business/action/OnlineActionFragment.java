...
public class OnlineActionFragment extends BaseNetFragment<MyTripBean> {
    ...
    public static OnlineActionFragment newInstance() {
        OnlineActionFragment fragment = new OnlineActionFragment();
...
//        testCall.enqueue(this);
    ...
    private void initView() {
        ...
        onlineSp.setColorSchemeColors(getActivity().getResources().getColor(R.color.color_ff9600));
        onlineSp.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
        ...
        onlineRv.setLayoutManager(layoutManager);
        onlineRv.setAdapter(mAdapter);
        getData("");
    ...
    protected int getContentResId() {
        return R.layout.frg_online_action;
    }
